...
export class SystemUsersComponent implements OnInit {
  ...
  ngOnInit () {
    this.userService.getUsersPagination(1, this.itemsPerPage, 0).subscribe(
      (responseBuilder) => {
        ...
        (responseBuilder) => {
          ...
          if (responseBuilder.code === + this.apiConfig.SUCCESS) {
            ...
            let title = isNew === true ? this.translatePipe.transform('Add New System User') :
              this.translatePipe.transform('Update System User');
            if (viewOnly) {
              title = this.translatePipe.transform('View System User');
            }

...
@Component({
  selector: 'app-template-profile-overview',
  templateUrl: './template-profile-overview.component.html',
  styleUrls: ['./template-profile-overview.component.css']
})
export class TemplateProfileOverviewComponent implements OnInit {
  activityData = [{
    month: 'January',
    spent: 240,
    opened: 8,
